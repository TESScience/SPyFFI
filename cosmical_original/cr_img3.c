...
#define NX 32
#define NY 32
// #define NX 32   // for testing
// #define NY 32

double gasdev(), poidev();

double image[NX][NY], origin[3], dx[3];   // CCD geometric parameters
...
void do_cosmic_ray(double v0[3], double a[3])
{
...
void cosmical(double exptm1, double exptm2, double crfl)
{
  double v0[3], a[3], ccddim[3], th, ph, exptm, rfac;
  int i, j, icr, ncrmn, ncr;
  unsigned long seed;
